...
public class PaymentReceivedReportController implements Initializable {
    ...
    private void setupTable() {
        ...
        // Apply custom Marathi font (20px) to Customer, PaymentMode, Bank columns
        applyCustomFontToColumn(colCustomer, marathiFontFamily);
    ...
    private void applyEnglishFontToColumn(TableColumn<SalesPaymentReceipt, String> column) {
        column.setCellFactory(col -> new TableCell<SalesPaymentReceipt, String>() {
            @Override
    ...
    private void applyCustomFontToColumn(TableColumn<SalesPaymentReceipt, String> column, String fontFamily) {
        column.setCellFactory(col -> new TableCell<SalesPaymentReceipt, String>() {
            @Override
            protected void updateItem(String item, boolean empty) {
                super.updateItem(item, empty);
